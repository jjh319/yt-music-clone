...
const page = async () => {
   ...
   return (
      <PagePadding>
         ...
         <PlayListCarousel playlistArray={playlistArray} title="새 앨범 및 싱글" subTitle="새로운 앨범" />
         <div className="mt-20"></div>
         <SongListCarousel songListTop10={songListTop10} title="새 앨범 및 싱글" subTitle="새로운 앨범" />
      </PagePadding>
   );
};
